...
3. Uma janela preta (terminal) vai abrir, compilar e iniciar o programa automaticamente
...
2. Dê permissão de execução ao script (só precisa fazer isso uma vez):
   ```bash
   chmod +x run.sh
   ```
3. Rode:
...
1. Descubra o IP local do computador que está rodando o servidor:
