...
public class ServidorWeb {
    ...
    void iniciar() throws IOException {
        ...
        servidor.start();
        System.out.println("Servidor rodando em http://lista-de-compras.ast");
        System.out.println("Porta interna: " + porta);
    }

    private int obterPorta() {
        String portaConfigurada = System.getenv("PORTA_SERVIDOR");
        ...
        try {
            int porta = Integer.parseInt(portaConfigurada);
            if (porta < 1 || porta > 65535) {
                throw new IllegalArgumentException("A porta deve estar entre 1 e 65535.");
            }
            return porta;
        } catch (NumberFormatException e) {
            throw new IllegalArgumentException("PORTA_SERVIDOR deve ser um numero valido.", e);
        }
    }
}
